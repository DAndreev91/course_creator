...
## Сводка изменений относительно версии 1.0

На основе рецензий ведущего аналитика (SA/BA) и Senior Software Engineer (C#/Data) внесены следующие ключевые изменения:

| № | Запрос из рецензии | Статус | Решение архитектора |
|---|---|---|---|
| 1 | 🔴 Добавить Business Value для каждого артефакта | ✅ Исправлено | Добавлены блоки «Business Value» с метриками в разделы 2.1, 2.2, 2.3 |
| 2 | 🔴 Исправить `.Result` антипаттерн в C# | ✅ Исправлено | Заменён на async/await + using HttpClient |
| 3 | 🔴 Добавить секцию безопасности | ✅ Исправлено | Добавлен раздел 5.4 Security Checklist |
| 4 | 🔴 Добавить BPMN → C4 bridge | ✅ Исправлено | Добавлен раздел 5.5 с диаграммой |
| 5 | 🔴 Пояснение к cross-DB SQL-запросу | ✅ Исправлено | Добавлено примечание про oracle_fdw/dblink |
| 6 | 🟡 Добавить Outbox Pattern реализацию | ✅ Исправлено | Добавлен шаг 3.5 в кейс ONE Retail |
| 7 | 🟡 Добавить fallback/circuit breaker в YARP | ✅ Исправлено | Добавлены health checks и fallback |
| 8 | 🟡 Усилить NFR-составляющую | ✅ Исправлено | Добавлена цепочка NFR → ADR → Fitness Function |
| 9 | 🟡 Добавить OpenAPI в кейс | ✅ Исправлено | Добавлен шаг 2.5 |
| 10 | 🟡 Исправить CI: psql/sqlplus без установки | ✅ Исправлено | Добавлены шаги установки |
| 11 | 🟡 Исправить PlantUML -checkonly | ✅ Исправлено | Заменён на `-syntax` |
| 12 | 🟡 Добавить консистентность данных (Saga) | ✅ Исправлено | Добавлено обсуждение в шаг 2 |
| 13 | 🟡 Добавить мониторинг | ✅ Исправлено | Раздел 5.6 |
| 14 | 🟡 Добавить ETL-скрипт миграции | ✅ Исправлено | Приложение E |
| 15 | 🟢 Сократить L4, расширить L1 | ✅ Исправлено | L4 — 1 абзац, L1 — расширен |
| 16 | 🟢 Определения Bounded Context, Event Storming | ✅ Исправлено | Добавлены сноски |
| 17 | 🟢 Добавить практические задания | ✅ Исправлено | 3 формальных упражнения |
