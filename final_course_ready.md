...
- **Abstractness (A)** = Na / Nc - доля абстрактных классов/интерфейсов, где Na — количество абстрактных сущностей в пакете: интерфейсы + абстрактные классы, Nc — количество конкретных (неабстрактных) сущностей: конкретные классы.
  - **Диапазон:** \(A in [0, 1]\)  
